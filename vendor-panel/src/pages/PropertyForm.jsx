...
export default function PropertyForm() {
  ...
  function handleSubmit(e) {
    ...
    const path = isEdit ? `/api/vendor/properties/${id}` : '/api/vendor/properties';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/properties" className="mt-4 inline-block text-amber-600 hover:underline">Back to list</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-slate-50">
      <header className="bg-white shadow-sm px-4 py-4 sm:px-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Link to="/properties" className="text-slate-600 hover:text-slate-900 text-sm font-medium">← My properties</Link>
      ...
      <main className="max-w-4xl mx-auto p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link to="/properties" className="px-6 py-2.5 rounded-xl border border-slate-300 text-slate-700 font-medium hover:bg-slate-100">
              Cancel
            </Link>
          </div>
        </form>
